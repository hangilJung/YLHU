...
insert into news_message values(msg_num.nextval,'don','123','title','감투는 어떄..?',sysdate);
insert into news_message values(msg_num.nextval,'jae','123','title','파도가 끝나는 곳까지...',sysdate);
